...
const Cart = () => {
  ...
  return (
    <div className="relative bg-[#FCF7E6] min-h-screen w-full py-20 px-4 flex flex-col items-center z-20">
      ...
      {/* 🧩 Conditional Rendering for Empty Cart or Loading State */}
      {!users ? (
        <p className="text-center text-lg text-[#5B2C06]">Loading...</p>
      ) : cart.length === 0 ? (
                ...
                <div className="flex items-center gap-4 w-full md:w-auto">
                  ...
                  <div>
                    <NavLink
                      ...
                      className="text-lg font-semibold text-[#5B2C06]"
                    >
                      {c.product.title}
                    </NavLink>
